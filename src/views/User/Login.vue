<template>
  <div
    class="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-100 to-blue-300 dark:from-gray-900 dark:to-gray-800 p-4">
    <div class="w-full max-w-md">
      <div class="flex flex-col items-center space-y-3 mb-8">
        <div
          class="relative w-20 h-20 mb-3 bg-blue-600 rounded-2xl shadow-lg flex items-center justify-center text-white text-3xl font-bold">
      ...
      <div
        ...
        <div class="p-8 space-y-5">
          <form @submit.prevent="handleLogin" class="space-y-5">
            ...
            <div class="relative">
              <input v-model="user.password" id="password" :type="showPassword ? 'text' : 'password'" required
                minlength="6"
                class="peer w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-700 outline-none transition-all"
            ...
            <button type="submit"
              ...
              <svg v-if="isLoading" class="animate-spin mr-2 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="p-6 border-t border-gray-200 dark:border-gray-700 text-center bg-gray-50 dark:bg-gray-900/30">
          <p class="text-sm text-gray-500 dark:text-gray-400">
            ...
            <router-link to="/user/register"
              class="text-blue-600 hover:text-blue-500 dark:text-blue-400 font-medium">Đăng ký</router-link>
          </p>
        </div>
      </div>
    </div>
