            ...
            <div class="card text-center">
              <div class="card-body">
                ...
                <div class="mt-3">
                  <h4>DAT BUI</h4>
                  <!-- Số dư ví -->
                  <p class="text-muted mb-1">Số dư ví: <strong>500.000đ</strong></p>
          ...
          <div class="col-lg-8">
            <div class="card">
              <div class="card-body">
                ...
                <div class="mb-3 row">
                  <label class="col-sm-3 col-form-label">Căn Hộ Đang Ở</label>
                  <div class="col-sm-9">
                ...
                <div class="mb-3 row">
                  <label class="col-sm-3 col-form-label">Số CCCD</label>
                  <div class="col-sm-9">
