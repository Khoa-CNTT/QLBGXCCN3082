<template>
    <div class="row">
        <div class="col-lg-3 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mt-2">Thêm Mới Giao Dịch</h5>
                </div>
                <div class="card-body">
                    <label class="mb-2">Tên Cư Dân</label>
                    <input type="text" class="form-control mb-2" />
                    <label class="mb-2">Số Tiền Giao Dịch</label>
                    <input type="text" class="form-control mb-2" />
                    <label class="mb-2">Phương Thức Thanh Toán</label>
                    <input type="text" class="form-control mb-2" />
                    <label class="mb-2">Ngày Hết Hạn</label>
                    <input type="text" class="form-control mb-2" />
                    <label class="mb-2">Mã Giao Dịch</label>
                    <input type="text" class="form-control mb-2" />
                    <label class="mb-2">Trạng Thái Giao Dịch</label>
        ...
        <div class="col-lg-9 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mt-2">Danh Sách Giao Dịch</h5>
                </div>
                <div class="card-body">
