<template>
   <div class="row">
        <div class="col-lg-3 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mt-2">Thêm Mới Chi Tiết Bãi Xe</h5>
                </div>
                <div class="card-body">
                    <label class="mb-2">Tên Bãi Xe</label>
                    <input type="text" class="form-control mb-2" />
                    <label class="mb-2">Thứ Tự Giữ Xe</label>
                    <input type="text" class="form-control mb-2" />
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mt-2">Danh Sách Chi Tiết Bãi Giữ Xe</h5>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Tên Bãi Xe</th>
                            <th class="text-center">Thứ tự giữ xe</th>
