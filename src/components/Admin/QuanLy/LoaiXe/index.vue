<template>
    <div class="row">
        <div class="col-lg-3 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mt-2">Thêm Mới Loại Xe</h5>
                </div>
                <div class="card-body">
                    <label class="mb-2">Tên Loại Xe</label>
                    <input type="text" class="form-control mb-2" />
                    <label class="mb-2">Tiên Thu Giữ Xe</label>
                    <input type="text" class="form-control mb-2" />
        ...
        <div class="col-lg-9 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mt-2">Danh Sách Loại Xe</h5>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Tiền Thu Giữ Xe</th>
